...
VALUES('TOEIC/TOEIC SPEAKING', 'TOEIC 관련 그룹을 등록해주세요.', 1, NOW());

INSERT INTO stugrp(stugrpname, stugrpex, seqno, rdate)
VALUES('전산', '전산관련 그룹을 등록해주세요.', 2, NOW());

INSERT INTO stugrp(stugrpname, stugrpex, seqno, rdate)
VALUES('국가기술', '국가기술관련 그룹을 등록해주세요.', 3, NOW());

INSERT INTO stugrp(stugrpname, stugrpex, seqno, rdate)
VALUES('기타', '기타스터디 관련 그룹을 등록해주세요.', 4, NOW());
