...
<DIV class='content_body'>
  <ASIDE class="aside_right"> <!-- 서브 메뉴 -->
    ...
    <span class='menu_divide' >│</span>
    <A href="./list_by_stuno_search_paging.do?stuno=${stuVO.stuno }&now_page=${param.now_page }">기본 목록형</A>
  </ASIDE> 
  
<%--  <DIV class='menu_line'></DIV>
  <ASIDE class="aside_right"> <!-- 서브 메뉴 -->
    <span class='menu_divide' >│</span>
    <A href="javascript:location.reload();">검색</A>    앵커 태그를 사용해 javaSript 사용 
    <span class='menu_divide' >│</span>
  </ASIDE>      --%>
        ...
        <c:choose>
          <c:when test="${size1 > 0}"> <!-- 파일이 존재하면 -->
            <c:choose> 
              ...
              <strong>${name}
              <span style='font-size: 0.9em;'>♥(${recom })</span>
              </strong></DIV>
              <strong>ID : ${id}</strong>
