...
<DIV class='content_body'>
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' action='./update.do'>
      ...
      <!-- 0414 PKKey 받아와야지 가능 -->
      <input type="hidden" name="favno" value='${param.favno }'>
      
      <label>즐겨찾기 그룹 번호 : </label>
       <input type='number' name='favgrpno' value='${param.favgrpno }' required="required" 
                  min="1" max="100" step="1" autofocus="autofocus"><BR> 
    
      <label>즐겨찾기 제목</label>
      <input type='text' name='favname' value='${favVO.favname }' required="required" style='width: 50%;'
                  autofocus="autofocus"><BR>
                 
      <label>즐겨찾기 설명</label>
      <input type='text' name='favex' value='${favVO.favex }' required="required" style='width: 50%;'
                  ><BR>         
  
      <label>즐겨찾기 링크</label>
      <input type='text' name='favli' value='${favVO.favli }' required="required" style='width: 50%;'
                  ><BR>         
