...
<DIV class='content_body'>    
          ...
          <li class="li_none">
            ...
            <c:if test="${file1saved.endsWith('jpg') || file1saved.endsWith('png') || file1saved.endsWith('gif')}">
              <DIV style="width: 30%; float: left; margin-right: 10px;">
                <IMG src="/member/storage/${memberVO.file1saved }" style="width: 100%;">
              </DIV>
              </c:if> 
          </li>   
       </ul>
    ...
    <FORM name='frm' id='frm' method='POST' action='./update.do' 
      ...
      <div class="form-group">
        <label class="col-md-2 control-label" style='font-size: 0.9em;'>회원 사진</label>    
      </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='vname' id='vname' 
                   value='${memberVO.vname }' style='width: 50%;' placeholder="별명">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='job' id='job' 
                   value='${memberVO.job }' style='width: 50%;' placeholder="직업">                   
      </div>
    </div>               
