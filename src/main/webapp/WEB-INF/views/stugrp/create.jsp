...
<DIV class='content_body'> 
  <FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
         <input type='text' name='stugrpname' value='' required="required" placeholder="ex) OOO 스터디 "
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
         <input type='text' name='stugrpex' value='' required="required" placeholder="ex) 소개 및 오픈채팅방 안내를 해주세요."
